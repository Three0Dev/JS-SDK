...
export default async function uploadWeb3Files(
	files: Array<File>
): Promise<string> {
	const token = await web3StorageClientAuth()
...
const web3StorageGateway = 'https://w3s.link/ipfs'

export { web3StorageGateway }
