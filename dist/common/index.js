import {connect as $170xe$connect, keyStores as $170xe$keyStores, WalletConnection as $170xe$WalletConnection, Contract as $170xe$Contract, utils as $170xe$utils} from "near-api-js";
import $170xe$orbitdb from "orbit-db";
import {create as $170xe$create} from "ipfs-core";
import {v4 as $170xe$v4} from "uuid";
import {generate as $170xe$generate} from "short-uuid";
...
function $bc09daf3d6fd99a8$export$2cd8252107eb640b() {
    return $bc09daf3d6fd99a8$var$__awaiter(this, void 0, void 0, function*() {
        ...
        const near = yield (0, $170xe$connect)(Object.assign({
            keyStore: new (0, $170xe$keyStores).BrowserLocalStorageKeyStore()
        }, nearConfig));
        // Initializing Wallet based Account. It can work with NEAR testnet wallet that
        // is hosted at https://wallet.testnet.near.org
        globalThis.walletConnection = new (0, $170xe$WalletConnection)(near, null);
        // Initializing our contract APIs by contract name and configuration
        globalThis.contract = new (0, $170xe$Contract)(globalThis.walletConnection.account(), nearConfig.contractName, {
...
const $f1f4ca456620baa2$var$initIPFS = ()=>$f1f4ca456620baa2$var$__awaiter(void 0, void 0, void 0, function*() {
        $f1f4ca456620baa2$var$ipfs = $f1f4ca456620baa2$var$ipfs || (yield $170xe$create($f1f4ca456620baa2$var$IPFS_CONFIG));
...
const $31f2ee8310cb2ee4$var$initOrbitDB = ()=>$31f2ee8310cb2ee4$var$__awaiter(void 0, void 0, void 0, function*() {
        ...
        if (loggedIn) {
            ...
            globalThis.orbitdb = yield (0, $170xe$orbitdb).createInstance(ipfs);
        } else globalThis.orbitdb = yield (0, $170xe$orbitdb).createInstance(ipfs);
    });
...
$parcel$export($71c4024da85ce832$exports, "web3StorageClientAuth", function () { return $71c4024da85ce832$export$8a5d2da6070a9018; }, function (v) { return $71c4024da85ce832$export$8a5d2da6070a9018 = v; });
...
const $71c4024da85ce832$var$url = "https://storage.three0dev.com";
function $71c4024da85ce832$export$8a5d2da6070a9018() {
...
function $71c4024da85ce832$export$2e2bcd8739ae039(files) {
    return $71c4024da85ce832$var$__awaiter(this, void 0, void 0, function*() {
        const token = yield $71c4024da85ce832$export$8a5d2da6070a9018();
...
function $30fd9ccd8434e85f$export$2e2bcd8739ae039() {
    return $30fd9ccd8434e85f$var$__awaiter(this, void 0, void 0, function*() {
        try {
            ...
            (0, $71c4024da85ce832$exports.web3StorageClientAuth)();
            globalThis.storageContract = new (0, $170xe$Contract)(globalThis.walletConnection.account(), storageAccount, {
                // View methods are read only. They don't modify the state, but usually return some value.
                viewMethods: [
                    "list_files",
                    "get_file"
...
function $a1479a46361190ed$export$2e2bcd8739ae039() {
    return $a1479a46361190ed$var$__awaiter(this, void 0, void 0, function*() {
        try {
            ...
            globalThis.tokenContract = new (0, $170xe$Contract)(globalThis.walletConnection.account(), tokenAccount, {
                // View methods are read only. They don't modify the state, but usually return some value.
                viewMethods: [
                    "ft_metadata",
                    "ft_balance_of",
...
const $400fea999f1b0043$export$d8658f5af792a7a4 = (address)=>$400fea999f1b0043$var$__awaiter(void 0, void 0, void 0, function*() {
        if (!(0, $170xe$orbitdb).isValidAddress(address)) return false;
        try {
...
function $c1ec8daeb266bd8b$export$a5575dbeeffdad98(file, path = "", description = "") {
    return $c1ec8daeb266bd8b$var$__awaiter(this, void 0, void 0, function*() {
        ...
        return globalThis.storageContract.nft_mint({
            token_id: $170xe$generate().toLowerCase(),
...
function $850fc221bb4eb62c$export$16015adca85344a() {
    return $850fc221bb4eb62c$var$__awaiter(this, void 0, void 0, function*() {
        yield globalThis.tokenContract.storage_deposit({
            ...
            amount: (0, $170xe$utils).format.parseNearAmount("0.00125")
        });
    });
}
